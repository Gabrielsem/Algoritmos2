...
// Pre: la lista fue creada.
// Post: Si la lista tiene elementos, se quita el primero de la lista,
// y se devuelve su valor.Si está vacía, devuelve NULL.
void *lista_borrar_primero(lista_t *lista);


// Pre: la lista fue creada.
// Post: Obtiene el valor del primer elemento de la lista. Si la lista tiene
// elementos, se devuelve el valor del primero, si está vacía devuelve NULL.
void *lista_ver_primero(const lista_t *lista);

// Pre: la lista fue creada.
// Post: Obtiene el valor del último elemento de la lista. Si la lista tiene
...
// Pre: la lista fue creada.
// Post: Devuelve un nuevo iterador al inicio de la lista o NULL si no se pudo
// crear.
...
// NULL si se encuentra vacía la lista o ya pasó el último elemento.
void *lista_iter_ver_actual(const lista_iter_t *iter);

// Pre: el iterador fue creado y no se usaron primitivas de la lista que
// la modifiquen desde que se creó.
// Post: Devuelve true si ya se pasó el último elemento de la lista,
// sino false.
